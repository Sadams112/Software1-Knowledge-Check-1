...
switch (input)
{
    ...
    case "3":
        ...
        if (int.TryParse(multiplyNumber1, out int multiplyNumOne) &&
            int.TryParse(multiplyNumber2, out int multiplyNumTwo))
        {
        ...
        {
            Console.WriteLine("One of more of the numbers is not an int");
        }
        break;
